...
const DIST_PATH = path.join(config.ROOT_PATH, 'releases')
...
const darwin = {
    ...
    'helper-bundle-id': 'gg.blockhub-helper',
...
function buildDarwin(cb) {
    ...
    electronPackager(Object.assign({}, all, darwin), function (err, buildPath) {
        ...
        infoPlist.CFBundleDocumentTypes = [
            {
                CFBundleTypeExtensions: ['blockhub'],
                CFBundleTypeIconFile: path.basename(config.APP_FILE_ICON) + '.icns',
                CFBundleTypeName: 'BlockHub Document',
                CFBundleTypeRole: 'Editor',
                LSHandlerRank: 'Owner',
                LSItemContentTypes: ['gg.blockhub']
            },
            {
        ...
        infoPlist.CFBundleURLTypes = [
            {
                ...
                CFBundleURLName: 'BlockHub Magnet URL',
                CFBundleURLSchemes: ['magnet']
            },
            {
                CFBundleTypeRole: 'Editor',
                CFBundleURLIconFile: path.basename(config.APP_FILE_ICON) + '.icns',
                CFBundleURLName: 'BlockHub Stream-Magnet URL',
        ...
        infoPlist.UTExportedTypeDeclarations = [
            {
                ...
                UTTypeDescription: 'BlockHub Document',
                UTTypeIconFile: path.basename(config.APP_FILE_ICON) + '.icns',
                UTTypeIdentifier: 'gg.blockhub',
                UTTypeReferenceURL: 'http://www.blockhub.org/beps/bep_0000.html',
                UTTypeTagSpecification: {
                    'com.apple.ostype': 'TORR',
                    'public.filename-extension': ['blockhub'],
                    'public.mime-type': 'application/x-blockhub'
                }
            }
        ]
    ...
    electronPackager(Object.assign({}, all, win32), function (err, buildPath) {
        ...
        function packageInstaller(filesPath, destArch, cb) {
            ...
            installer.createWindowsInstaller({
                 ...
                 */
                // remoteToken: process.env.BLOCKHUB_GITHUB_API_TOKEN,
                ...
                .then(function () {
                   ...
                   */
                    ...
                    if (destArch === 'ia32') {
                        ...
                        // BlockHub-vX.X.X-full.nupkg -> BlockHub-vX.X.X-ia32-full.nupkg
                        fs.renameSync(
