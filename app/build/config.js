...
const PORTABLE_PATH = IS_TEST ? path.join(process.platform === 'win32' ? 'C:\\Windows\\Temp' : '/tmp', 'BlockHubTest') : path.join(path.dirname(process.execPath), 'Portable Settings');
...
module.exports = {
  ...
  WINDOW_MIN_HEIGHT: UI_HEADER_HEIGHT + UI_MAIN_HEIGHT * 2,
  // header + 2 torrents
...
function isProduction() {
  return process.env.NODE_ENV === 'production'; // if (!process.versions.electron) {
  //     // Node.js process
  //     return false
  // }
